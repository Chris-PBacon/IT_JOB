  ...
  <div class="container1" id="containerf" style="margin: auto; margin-top: 100px; margin-bottom: 100px; height: 600px;" >
    <div class="form-container sign-up-container" >  
      <form action="joinE.do" method="post">
        ...
        <input type="text" name="memEntName" placeholder="기업명"  required/>
        <input type="text" name="memEntId" placeholder="ID" required/>
        <input type="password" name="memEntPw" placeholder="Password" required/>
        <input type="number" name="memEntNum" placeholder="사업자번호 : ' - ' 없이 숫자만 입력" />
        <input type="email" name="memEntEmail" placeholder="Email" required/>
        <input type="number" name="memEntPhone" placeholder="Phone :  ' - '없이 숫자만 입력" required/>
        <div style="display: flex; align-items: center;">
         <span style="font-size: 18px; margin: 20px; margin-bottom: 25px;">기업 소재지 : </span> 
         <select name="memEntPlace" required>
            ...
            <option value="general16">지역무관</option>
          </select>
        </div>
    ...
    <div class="form-container sign-in-container">
      <form action="loginE.do" method="post">
        ...
        <input type="text" name="memEntId" placeholder="ID" />
        <input type="password" name="memEntPw" placeholder="Password" />
