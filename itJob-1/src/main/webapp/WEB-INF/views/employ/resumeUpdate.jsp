...
<div class="body-all">
  ...
  <!-- 이력서 form -->
  <form method="post" action="resumeUpdate.do" id="resume-form">

    <!-- 사진 첨부칸 -->
    <div id="img-div">
    <h3>증명사진</h3>
    <div class="form-floating mb-3">
      <input type="text" class="form-control" id="floatingInput" name="r_img" value="${rvo.r_img}" placeholder="name@example.com" required>
    ...
    <c:choose>
    	<c:when test="${rvo.r_exp == 1}">
	    	<input type="radio" class="btn-check " name="r_exp" value="1" id="btnradio1" autocomplete="off" checked>
    	...
    	<c:when test="${rvo.r_exp == 0}">
	        ...
	        <input type="radio" class="btn-check" name="r_exp" value="0" id="btnradio2" autocomplete="off" checked>
	        <label class="btn btn-outline-primary" for="btnradio2">경력 무</label>
    	</c:when>
    </c:choose>
    </div>
    ...
    <table class="table table-bordered" id="school-table" style="width: 100%; border-collapse: collapse;">
      ...
      <tr>
          <td><input type="text" name="r_school" value="${fn:split(rvo.r_school, ',')[0]}" style="width: 100%; border: 0;"></td>
          <td><input type="text" name="r_school" value="${fn:split(rvo.r_school, ',')[1]}" style="width: 100%; border: 0;"></td>
          <td><input type="text" name="r_school" value="${fn:split(rvo.r_school, ',')[2]}" style="width: 100%; border: 0;"></td>
          <td><input type="text" name="r_school" value="${fn:split(rvo.r_school, ',')[3]}" style="width: 100%; border: 0;"></td>
      </tr>
    </table>
    ...
    <div class="license">
      ...
      <table class="table table-bordered" id="license-table" style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
            <td><input type="text" name="r_license" value="${fn:split(rvo.r_license, ',')[0]}" style="width: 100%; border: 0;"></td>
            <td><input type="text" name="r_license" value="${fn:split(rvo.r_license, ',')[1]}" style="width: 100%; border: 0;"></td>
        </tr>
        <tr>
          <td><input type="text" name="r_license" value="${fn:split(rvo.r_license, ',')[2]}" style="width: 100%; border: 0;"></td>
          <td><input type="text" name="r_license" value="${fn:split(rvo.r_license, ',')[3]}" style="width: 100%; border: 0;"></td>
        </tr>
      </table>
    </div>
  ...
  <div class="intro-color">
    ...
    <div id="intro" class="intro">
      <div id="add-div">
		          ...
		          <textarea name="rm_content" value="${rsvo.rm_content}" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 270px">${rsvo.rm_content}</textarea>
    ...
    <div style="width: 80%;">
      <button type="button"  id="add-btn">항목 추가</button>
    </div>
    ...
    <!-- 전송버튼 -->
    <button type="submit" id="last-btn" class="btn btn-primary">수정</button>
    <br><br><br><br> 
    </div>
...
<script>
    ...
    $('#add-btn').click(function() {
        ...
        <div id="intro-contents-only" class="intro-contents" style="display: flex;">
			...
			<div class="form-floating intro-input" id="page-move">
